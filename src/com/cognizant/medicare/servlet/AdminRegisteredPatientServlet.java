...
/**
 * Servlet implementation class AdminRegisteredPatientServlet
 */
@WebServlet("/AdminRegisteredPatient")
public class AdminRegisteredPatientServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.getRequestDispatcher("admin-registered-patient.jsp").forward(request, response);
