...
/**
 * Servlet implementation class AdminEditMedicareServlet
 */
@WebServlet("/AdminEditMedicare")
public class AdminEditMedicareServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("edit-admin-medicare-status.jsp").forward(request, response);
