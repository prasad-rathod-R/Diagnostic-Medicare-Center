...
/**
 * Servlet implementation class ShowMedicareServlet
 */
@WebServlet("/ShowMedicare")
public class ShowMedicareServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("show-medicare.jsp").forward(request, response);
    }
