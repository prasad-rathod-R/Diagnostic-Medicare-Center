...
<body class="background">
    ...
    <div class="login-box">
        ...
        <form action="AdminLginServlet" method="post" name="login" onsubmit="return validateLogin()"
            autocomplete="off">
            <p>Username</p>
            <input type="text" name="username" placeholder="Enter Username" />
            <p>Password</p>
            <input type="password" name="password" placeholder="Enter Password" /> <input
                type="submit" name="submit" value="login" /> <a href="admin-registration.jsp">Don't
                have account Register now?</a>
        </form>
    </div>
    <footer>
    <b> Copyright &copy; 2020 | Toll Free No. 1800 267 1006</b></footer>
</body>
</html>