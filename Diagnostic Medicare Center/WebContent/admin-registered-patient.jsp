...
<body class="background">
    ...
    <form action="AdminRegisteredPatient" method="post" name="medicare1"
        onsubmit="return validateFormPatient()" autocomplete="off">
        <h2 class="successmessage">${successmessage}</h2>
        <h2 class="failure">${failure}</h2>
        <table class="form2" cellspacing=18px>
            <th colspan=2><h2>Add Patient</h2></th>
            <tr>
                <td>Patient Id</td>
            ...
            <tr>
                ...
                <td><input type="Date" name="dateOfBirth" size=30 id="dateOfBirth"
                    onblur="ageCount(this)" /></td>
            </tr>
            <tr>
                <td>Age*</td>
                <td><input type="text" name="age" placeholder="Enter Age" size=30 id="age" /></td>
            </tr>
            <tr>
                <td>Gender*</td>
