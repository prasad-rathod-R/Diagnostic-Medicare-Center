...
/**
 * Servlet implementation class AdminShowEditMedicareServlet
 */
@WebServlet("/AdminShowEditMedicare")
public class AdminShowEditMedicareServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("admin-edit-medicare.jsp").forward(request, response);
    }
