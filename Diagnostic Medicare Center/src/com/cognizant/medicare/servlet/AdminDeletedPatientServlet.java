...
/**
 * Servlet implementation class AdminDeletedPatientServlet
 */
@WebServlet("/AdminDeletedPatient")
public class AdminDeletedPatientServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.getRequestDispatcher("admin-patient-view-empty.jsp").forward(request, response);
        }
    }
