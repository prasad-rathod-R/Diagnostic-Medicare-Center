...
/**
 * Servlet implementation class AdminViewTestResultServlet
 */
@WebServlet("/AdminViewTestResult")
public class AdminViewTestResultServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("admin-view-test-results.jsp").forward(request, response);
    }
