...
public class DoctorRegistrationServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.getRequestDispatcher("doctor-registration-status.jsp").forward(request,
                    response);
            ...
            request.getRequestDispatcher("doctor-registration.jsp").forward(request, response);
        }
    }
}
